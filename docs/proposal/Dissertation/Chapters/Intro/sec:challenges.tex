%% SECTION HEADER /////////////////////////////////////////////////////////////////////////////////////
\section{Challenges in damage assessment in the \acs{hsc}}
...
Despite the small size of the plate (\numproduct{179 x 159} \unit{\square\mm}), the model has more than 1.5 million \acp{dof} because the skins and the core are composed of 3D elements.
