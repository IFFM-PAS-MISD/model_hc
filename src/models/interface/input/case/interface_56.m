...
% Signal definition
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
freq_range = 'pulse_25kHz';% freq_range='1MHz';freq_range='0.5MHz';% freq_range='pulse_signal';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
'number of nodes on edge element on X,Y';   n = 120;
switch DOF
    case 3
...
'ply thickness [m]';              ply_thick = 4.0/lay*1e-3;
...
% geometry definition
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
'in x direction - total length [m]';                Lx = 600e-3;
'in y direction - total width [m]';                 Ly = 600e-3;
...
numberElementsZ = 1;
inputfile = 'plate_600_600_2_pzt_f50_25kHz_00mm_49';
