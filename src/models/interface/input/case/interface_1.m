...
% Signal definition
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
freq_range = 'pulse_25kHz_2';% freq_range='1MHz';freq_range='0.5MHz';% freq_range='pulse_signal';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
'number of nodes on edge element on X,Y';   n = 10;
switch DOF
    case 3
...
numberElementsY = 1;
numberElementsZ = 1;
inputfile = 'plate_600_600_2_pzt_f50_25kHz_00mm_0';
