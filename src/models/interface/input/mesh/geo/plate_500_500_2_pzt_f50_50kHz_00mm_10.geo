...
L = 0.4000; W = 0.400;
xpzt_1 = -0.075; ypzt_1 = 0.000000;
xpzt_2 = 0.075; ypzt_2 = 0.000000;
...
//+
Transfinite Curve {8, 9, 10, 14, 15, 16} = 5 Using Progression 1;
//+
Transfinite Curve {1,2,3,4} = 15 Using Progression 1;
