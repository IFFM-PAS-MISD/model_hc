...
stAttach = [2;1;false;3;1]; % assign structure which element is attached to
interfaceElements = [];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
stAttach = [L_str,L_str+2;-1,1;false,false;3 3;1 1]; % assign structure which element is attached to
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
'shift in z direction - total thickness [m]';       shiftZ = ...
    (structure(L_str).geometry(6)+structure(L_str).geometry(3)/2+Lz/2);
stAttach = [L_str, L_str+2, L_str+3; -1,1,1;false,false,false;3 3 3;1 3 3]; % assign structure which element is attached to
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
stAttach = [L_str; -1; true; 3;3]; % assign structure which element is attached to
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
'honeycomb cell inner diagonal [m]';  D_h = [];%ones(1,lay) * 19.0e-3;
'honeycomb cell wall thickness [m]';  W_h = [];%ones(1,lay) * 50.0e-6;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
