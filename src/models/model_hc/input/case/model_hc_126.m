...
numberElementsY = 20;
numberElementsZ = 1;
inputfile = 'circle_2_pzt_50kHz_30mm';
...
mesh_type = 'gmsh';
inputfile = 'circle_2_pzt_15kHz_1_30mm';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
structure_content                 %%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
dmgPrpReduction = 100;
dmgStructure = 2;
'in x direction - total length [m]';           Lx_dmg = 30e-3;
'in y direction - total width [m]';            Ly_dmg = 30e-3;
