...
stAttach = []; % assign structure which element is attached to
interfaceElements = [];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% core
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
DOF = 5;      % degree of freedom 3 for 3d, 5 for 2d, 6 for core
n = 6;
switch DOF
    case 3
    nzeta = 4;   % number of nodes on edge element on Z
...
n_y = n;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
structure_material = 'aluminium_air';
ply_thick = W_h;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% properites of material layers
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
'shift in z direction - total thickness [m]';           shiftZ = ...
    (structure(L_str).geometry(6)+structure(L_str).geometry(3)/2+Lz/2);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
mesh_type = 'honeycomb_homonogized';
%force nodes and values
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
structure_content                 %%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
intStruct = struct('pair',{[2, 1]});
intStruct(1).rangeX = [-0.5 0.5] * structure(2).geometry(1) + structure(2).geometry(4);
intStruct(1).rangeY = [-0.5 0.5] * structure(2).geometry(2) + structure(2).geometry(5);
intStruct(1).rangeZ = [-0.5 -0.5] * structure(2).geometry(3) + structure(2).geometry(6);
intStruct(1).h = 0.5*[structure(1).geometry(3) -structure(2).geometry(3)];
intStruct(1).type = 'rect';

intStruct(2).pair = [2, 3];
intStruct(2).rangeX = [-0.5 0.5] * structure(3).geometry(1) + structure(2).geometry(4);
intStruct(2).rangeY = [-0.5 -0.5] * structure(2).geometry(2) + structure(2).geometry(5);
intStruct(2).rangeZ = [-0.5* structure(1).geometry(3) + structure(1).geometry(6) 10e-3];
intStruct(2).h = 0.5*[structure(1).geometry(3) -structure(2).geometry(3)];
intStruct(2).type = 'cylinder_z';
