...
% Signal definition
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
freq_range = 'pulse_20(5)kHz';% freq_range='1MHz';freq_range='0.5MHz';% freq_range='pulse_signal';
...
'stack angle sequence [deg]';     lalpha = [0,90,90,0]*1; 
...
% 'honeycomb_skin'; 
mesh_type = 'rect';
'honeycomb cell inner diagonal [m]';  D_h = ones(1,lay) * 10.0e-3;
'honeycomb cell wall thickness [m]';  W_h = ones(1,lay) * 100.0e-6;
stShape = 'rect';
numberElementsX = 50;
numberElementsY = 50;
numberElementsZ = 1;
...
'ply thickness [m]';              ply_thick = 100.0/lay*1e-6;
'stack thickness sequence [m]';   lh = ones(1,lay)*ply_thick; 
...
stAttach = [L_str, L_str+2, L_str+3; -1,1,1;true,false,false]; 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% if 'file_mesh' put the file name from \Input folder, 'honeycomb_skin',
% 'honeycomb_core'; 
mesh_type = 'rect';
...
% geometry definition
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
'shift in x direction - total length [m]';  shiftX = -45e-3;
'shift in y direction - total width [m]';   shiftY = -200e-3;
%assign structure which element is attached to
stAttach = [L_str; -1; true]; % assign structure which element is attached to
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
