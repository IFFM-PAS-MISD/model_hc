...
'Project name';                      name_project = 'smart2019';
'Mesh';                              name_mesh = '';
'delam_element file';                name_delam = 'non';
'interface_element file';            name_interface = 'non';
% Signal definition
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
freq_range = 'pulse_150kHz';% freq_range='1MHz';freq_range='0.5MHz';
...
'stack angle sequence [deg]';     lalpha = [-45 45 90 45]*1; 
...
% geometry definition
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
'in x direction - total length [m]';        Lx = 800e-3;
'in y direction - total width [m]';         Ly = 455e-3;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
structure_material = 'composite_PF2_t60_p200';
...
'ply thickness [m]';              ply_thick=0.25/lay*1e-3;
'stack thickness sequence [m]';   lh = ones(1,lay)*ply_thick; 
...
stAttach = [L_str 3;-1 1;true false]; % assign structure which element is attached to
interfaceElements = [];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Boundary condition available: 'cccc','cccf','ssff','ffff''ssss' 
BC = 'ffff'; 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
'fiber_type-no or type of fiber'; fiber_type='unidirectional';
'number of material layers';      lay = 3;
'ply thickness [m]';              ply_thick=0.75/lay*1e-3;
'stack thickness sequence [m]';   lh = ones(1,lay)*ply_thick; 
'stack angle sequence [deg]';     lalpha = [-45 90 -45]*1; 
'stack matrix sequnce';           lmat = ones(1,lay)*1; 
'stack fibres sequece';           lfib = ones(1,lay)*1; 
'volume fraction of fibres';      lvol = ones(1,lay)*0.49;
'damping coefficients';           alpha=[0.7e4;0.7e4;0.7e4;0.7e4;0.7e4];
...
'shift in z direction - total thickness [m]';     shiftZ =...
    (structure(L_str).geometry(6)+structure(L_str).geometry(3)/2+Lz/2);
stAttach = [L_str 4 5;-1 1 1 ;true false false]; % assign structure which element is attached to
interfaceElements = [];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Boundary condition available: 'cccc','cccf','ssff','ffff''ssss' 
BC = 'ffff'; 
...
'in z direction - total thickness [m]';     Lz = sum(lh);
'shift in x direction - total length [m]';  shiftX = -150e-3;
'shift in y direction - total width [m]';   shiftY = -57e-3;
'shift in z direction - total thickness [m]';shiftZ =...
    (structure(1).geometry(6)+structure(1).geometry(3)/2+Lz/2);
