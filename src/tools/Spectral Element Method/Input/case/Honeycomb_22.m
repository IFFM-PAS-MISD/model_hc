...
'Mesh';                              name_mesh='';
'Name structure';                    name_structure=[name_project, '_22'];
'delam_element file';                name_delam='non';
'interface_element file';            name_interface='non';
% Signal definition
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
freq_range='pulse_20kHz';% freq_range='1MHz';freq_range='0.5MHz';
                     % freq_range='pulse_signal';

run(['freq_input_',name_project]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% output output_result=[sum electric charges on the top electrode;...
%                       displacements Z on bottom sureface;...
%                       velocity Z on the bottom sureface;
%                       voltage of PZT sensor]
