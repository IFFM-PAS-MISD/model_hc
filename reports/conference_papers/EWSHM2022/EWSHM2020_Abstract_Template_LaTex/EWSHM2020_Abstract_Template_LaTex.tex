...
\email{author@uni-hannover.de}}
%
\maketitle              % typeset the header of the contribution
%
%\begin{abstract}
\paragraph{Abstract.}
The abstract should summarize the contents of the paper in short terms, i.e. 150-250 words; justified between the margins and using the font/size specified below. The page size is standard A4, with the margins listed in Table below and ex-pressed in cm. The text area is 16.0 cm x 24.7 cm. The document is based on the font Times.
