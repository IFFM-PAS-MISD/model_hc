...
\TitleCitation{Model-Assisted Guided-Wave-Based Approach for Disbond Detection and Size Estimation in Honeycomb Sandwich Structures}
...
\Author{\hl{Piotr Fiborek} *\orcidA{} and \hl{Pawe\l{} Kudela} 
 \orcidB{}}% MDPI: Please carefully check the accuracy of names and affiliations.
...
\address[1]{%
\hl{Institute} of Fluid Flow Machinery, Polish Academy of \hl{Sciences}, 80-231 Gdańsk, Poland%MDPI: Newly added information, please confirm.
;  \hl{imp@imp.gda.pl} %MDPI: This email is different from the one in our system,, please confirm.
}% MDPI: Please carefully check the accuracy of names, emails and affiliations.
...
\hl{Honeycomb} %Please confirm change to title.
...
According to the first-order shear deformation theory~\cite{reissner1945effect, mindlin1951influence}, the displacement field is expressed \hl{as}%Is the following equation bold necessary? Please confirm. Please check all like this in the text.
:
\begin{eqnarray}
\left \{ \begin{array}{c}
\textbf{u}^e(\xi,\eta) \\
...
\begin{figure}[H]
	\widefigure
		\includegraphics[scale=0.95]{figures/png/interface_2D3D}
...
The owner element is a spectral element in the domain of the substructure \(s_{ij}\), which contains the interface node, for example, interface node \(k_\Gamma=36\) (see~Figure~\ref{fig:interface}a) is located in the element \(e^{I}_{3D}\) and \(e^{III}_{2D}\) for the substructures \(s_{11}\) and \(s_{12}\), respectively.
...
%	\end{center}
	\caption{(\textbf{a}) \hl{The} %MDPI: The hyphen in the picture should be changed to minus sign, e.g., ``-0.5'' to ``$-$0.5'', please change. Please check all like this in all figures.
...
\begin{figure}[H]
%	\begin{center}
		\includegraphics[width=0.95\linewidth]{figures/png/fullfield}
%	\end{center}
	\caption{\hl{The} %MDPI: The hyphen in the picture should be changed to minus sign, e.g., ``-92'' to ``$-$92'', please change. Please check all like this in all figures.
...
\begin{figure}[H]
%	\begin{center}
		\includegraphics[width=0.98\linewidth]{figures/png/fullfield_dam5}
%	\end{center}
	\caption{\hl{The} %MDPI: The hyphen in the picture should be changed to minus sign, e.g., ``-92'' to ``$-$92'', please change. Please check all like this in all figures.
...
\begin{figure}[H]
%	\begin{center}
		\includegraphics[width=0.95\linewidth]{figures/png/I_eng}
%	\end{center}
...
\begin{figure}[H]
%	\begin{center}
		\includegraphics[width=0.95\linewidth]{figures/png/I_amp}
%	\end{center}
	\caption{\textls[-25]{\hl{Relative} %MDPI: The picture is incomplete (The ordinates of the two pictures on the right are cut off by the screenshot), please change. Please make all figures are completed.
...
%	\end{center}
	\caption{\hl{The} %MDPI: The hyphen in the picture should be changed to minus sign, e.g., ``-1'' to ``$-$1'', please change. Please check all like this in all figures.
...
\begin{figure}[H]
%	\begin{center}
		\includegraphics[width=0.65\linewidth]{figures/png/MADIF}
%	\end{center}
...
The extended model will be usable in developing SHM \hl{scenarios}%MDPI: please add the following Author Contributions, Institutional Review Board Statement, Informed Consent Statement and Data Availability Statement parts..
.
...
\institutionalreview{\hl{~}%In this section, please add the Institutional Review Board Statement and approval number for studies involving humans or animals. Please note that the Editorial Office might ask you for further information. Please add ``The study was conducted according to the guidelines of the Declaration of Helsinki, and approved by the Institutional Review Board (or Ethics Committee) of NAME OF INSTITUTE (protocol code XXX and date of approval).'' OR ``Ethical review and approval were waived for this study, due to REASON (please provide a detailed justification).'' OR ``Not applicable'' for studies not involving humans or animals. You might also choose to exclude this statement if the study did not involve humans or animals.
}
...
\newblock \emph{Micromechatronics: Modeling, Analysis, and Design with
  {MATLAB}{\textsuperscript{\textregistered}}}; \hl{CRC Press: Boca Raton, FL, USA,} %MDPI: newly added information, please confirm.
 2009.
...
\newblock {\em Structural Health Monitoring of Advanced Composites Using Guided
  ...
  Publishing: \hl{Chisinau, Moldova,} 2017.%MDPI: newly added information, please confirm.
...
\newblock  In Proceedings of the 8th European Workshop On Structural Health Monitoring
  (EWSHM 2016), Bilbao, Spain, \hl{5--8 July} 2016.%MDPI: newly added information, please confirm.
...
\newblock In Proceedings of the 53rd AIAA/ASME/ASCE/AHS/ASC Structures, Structural Dynamics and
  Materials Conference, \hl{Honolulu, HI, USA, 23--26 April} 2012; p. 1814.%MDPI: newly added information, please confirm.
...
\hl{25--28 October} 2008; Volume 2008, pp. 1--7.%MDPI: newly added information, please confirm.
...
\newblock Wavenumber study of guided waves in aluminum honeycomb sandwich
  structures.
\newblock   In Proceedings of the Health Monitoring of Structural and Biological Systems 2015, \hl{San Diego, CA, USA, 9--12 March} 2015; Volume 9438, p. 943807.%MDPI: newly added information, please confirm.
...
\newblock {\em Guided Waves in Structures for SHM: The Time-Domain Spectral
  Element Method}; John Wiley \& Sons:  \hl{Hoboken, NJ, USA,} 2011.%MDPI: newly added information, please confirm.
...
\newblock {\em Int. J. Numer. Methods Eng.} {\bf \hl{2000}%MDPI: Please add the volume number or doi number.
},  S1--S6.
